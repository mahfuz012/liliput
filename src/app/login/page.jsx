...
const LoginPage = () => {
  ...
  const {resetpasswordsubmit,loginProfile,userProfile,registerWithGoogle,registerWithFacebook} = useContext(AuthContextPro)
...
<p onClick={resetsubmit} className='btn btn-success'>reset</p>
      <p className='my-5 sm:px-5'>
           you haven't registered yet,
        <Link href={'/register'} className='font-bold text-xl mx-1 text-green-700'>
          Registration
        </Link>
      </p>
</div>
