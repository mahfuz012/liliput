...
const ragistraionfiles = () => {
  ...
  return (
    <div className="mb-20 border">
      <div className="sm:flex border-2 sm:justify-center ">
        <div
          style={{ alignItems: "center" }}
          className="sm:w-6/12  px-10 sm:px-0  sm:flex "
        >
          <form
            onSubmit={handleSubmit(submitFunction)}
            className="my-5 py-5 sm:text-center "
          >
...
export default ragistraionfiles;
