...
<p className='px-5 text-3xl font-serif my-5 text-indigo-700 '>Getting Started with Selling on Free-Flow: A Comprehensive Guide :</p>
...
<p className='font-bold my-2  text-gray-600'>Understanding Success</p>
<p className=''>Begin by researching successful profiles in your niche. Identify what sets them apart and how they present their services.</p>
</div>
</div>
...
<div className=' p-1 sm:ms-4'>
<p className='font-bold my-2 text-gray-600'>Create your seller profile</p>
...
<Link href={'/postjobs/overview'} ><button className='btn bg-success w-5/12 text-white my-8'>Continue</button></Link>
