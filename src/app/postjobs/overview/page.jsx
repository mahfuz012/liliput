      ...
      <div className="sm:flex">
        <div className="sm:w-4/12  p-5">
          <Image
            ...
            height={800}
            src={
              "https://plus.unsplash.com/premium_photo-1673976275849-986056b83cae?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=387&q=80"
            }
        ...
        <div className="sm:w-7/12  p-5">
          <h1 className="text-3xl mt-10 text-gray-600 font-semibold">
            What makes a successful{" "}
            <span className="text-bold text-red-500">Free-Flow</span> profile?
          </h1>
          <h1 className="my-3 text-gray-700">
          ...
          <div className=" mt-10 sm:flex gap-5">
            ...
            <div className="border sm:w-3/12 p-5 rounded-2xl">
              ...
              <p className="mt-4 text-sm text-gray-700">
                You might need to verify your ID for community security
              </p>
            </div>
          ...
          <div className="mt-16">
            ...
            <Link href="/postjobs" className="text-blue-600">
              Back
            </Link>
          </div>
        </div>
