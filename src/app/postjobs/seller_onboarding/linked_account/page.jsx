      ...
      <>
        ...
        >
          ...
          <input
            disabled={true}
            type="text"
            className="border text-center  border-gray-500 rounded-md p-3 mx-1 sm:w-3/12"
          ...
          {datarevovery ? (
            <>
              ...
              >
                <MdVerifiedUser className="text-3xl text-success" />
                Verified
              </p>
            </>
          ) : userProfile ? (
        ...
        <div className="text-center mt-8">
          <button
            ...
            className="btn bg-black text-white sm:w-2/12"
          >
            {userProfile ? (
          ...
          <p className="my-5 font-bold ">
            {" "}
            -- You can skip it if you want or verify it later Thanks --{" "}
          </p>
        </div>

        <div className="sm:flex justify-end mt-20">
          <Link
            href={"/postjobs/seller_onboarding/account_security"}
