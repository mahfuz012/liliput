...
const TheBest = () => {
    return (
        <div>
             <div className="bg-[#F1FDF7] px-2 py-14  mx-auto">
    ...
    <div className=" grid gap-6 md:w-1/2">
        <div>
          <h1 className="text-2xl font-bold"> &#9989; Stick to your budget</h1>
        ...
        <div>
          <h1 className="text-2xl font-bold"> &#9989; Count on 24/7 support</h1>
          <p className="text-2xl font-medium mt-1">
